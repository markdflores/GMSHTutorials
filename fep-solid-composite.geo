...
// Note: 
// You must comment one part before you save the mesh. 
//
nply_fep=1; 
nep_fep=nply; 
tol=0.001; 
For i In {0:(nply_fep-1)}
	...
	// Outer Rectangle
	// Hole In Plate!!
	x = (D-tol)*s; y = (D-tol)*s; z = T/2; lc = lc_R;
	...
	Extrude {0,0,-T} { Surface{s21[i]}; Layers{nep_fep}; Recombine;}
EndFor
/*
Field[1] = Box; 
Field[1].VIn = lc_S/4;  
