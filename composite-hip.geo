...
For i In {0:(nply-1)}
	...
	// Hole In Plate!!
	x = D/2; y = D/2; z = T/2; lc = lc_S;
	p00[{i}]=newp; Point(p00[i]) = { 0-x_D,    0-y_D, 	z-tply*i, lc};	
	p11[{i}]=newp; Point(p11[i]) = { x*sf-x_D, y*sf-y_D, 	z-tply*i, lc}; 
	p12[{i}]=newp; Point(p12[i]) = {-x*sf-x_D, y*sf-y_D, 	z-tply*i, lc}; 
	p13[{i}]=newp; Point(p13[i]) = {-x*sf-x_D,-y*sf-y_D, 	z-tply*i, lc}; 
	p14[{i}]=newp; Point(p14[i]) = { x*sf-x_D,-y*sf-y_D, 	z-tply*i, lc};
